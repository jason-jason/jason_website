                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal" action="__URL__/update" method='post' >
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control" name="LogoTitle" value="<?php echo ($data["LogoTitle"]); ?>" minlength="5" type="text" required />
                                          </div>
                                      </div>
									  <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Introduce <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control"name="Introduce" minlength="5" value="<?php echo ($data["Introduce"]); ?>" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Small_title1 <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" name="Small_title1" minlength="5" value="<?php echo ($data["Small_title1"]); ?>" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Small_title2_red <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" name="Small_title2_red" minlength="4" value="<?php echo ($data["Small_title2_red"]); ?>" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Small_title3 <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" name="Small_title3" minlength="5" value="<?php echo ($data["Small_title3"]); ?>" type="text" required />
                                          </div>
                                      </div>                                      
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Skill </label>
                                          <div class="col-lg-10">
                                              <textarea class="form-control"  name="Skill" required><?php echo ($data["Skill"]); ?></textarea>
                                          </div>
                                      </div>
                                      <div class="form-group">
