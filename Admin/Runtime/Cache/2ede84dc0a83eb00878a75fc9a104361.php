		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>Resume</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->   
                             ...
                             <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="get" action="">
                                      ...
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">LogoTitle <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["LogoTitle"]); ?> </label>
                                      </div>
									  <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Introduce <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["Introduce"]); ?> </label>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Small_title1 <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["Small_title1"]); ?> </label>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Small_title2_red <span class="required">*</span></label>
                                          <label style="color:red;" for="cname" class="col-lg-10"><?php echo ($vo["Small_title2_red"]); ?> </label>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Small_title3 <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["Small_title3"]); ?> </label>
                                      </div>                                      
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Skill <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["Skill"]); ?> </label>
                                      </div>
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
											  <a class="btn btn-primary" type="button" href="__URL__/modify/id/<?php echo ($vo["id"]); ?>">upadte</a>
											  <a class="btn btn-default" type="button" >delete</a>
                                          </div>
                                      </div>
                                  </form>
                              </div>
							  <!--- 
							  <p>Logo Title:<?php echo ($vo["Logo Title"]); ?></p>
							  <p>Introduce:<?php echo ($vo["Introduce"]); ?></p>
							  <p>Small_title1:<?php echo ($vo["Small_title1"]); ?></p>
							  <p>Skills:<?php echo ($vo["Skill"]); ?></p>
----->
                          </div>
                      </section>
                  </div>
