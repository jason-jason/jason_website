		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>Project</li>
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal" action="__URL__/update" method='post' >
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control" name="name" value="<?php echo ($data["name"]); ?>" minlength="5" type="text" required />
                                          </div>
                                      </div>
									  <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Links <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" name="links" value="<?php echo ($data["links"]); ?>" minlength="5" type="text" required />
                                          </div>
                                      </div>
									  <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Rank <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" name="rank" value="<?php echo ($data["rank"]); ?>" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Content </label>
                                          <div class="col-lg-10">
                                              <textarea class="form-control"  name="content" required><?php echo ($data["content"]); ?></textarea>
                                          </div>
                                      </div>
                                      <div class="form-group">
