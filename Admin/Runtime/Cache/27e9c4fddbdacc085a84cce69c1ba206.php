...
<head>
  ...
  <body class="login-img3-body">
    ...
    <div class="container">
      ...
      <form class="login-form" method="post" action="__URL__/do_login" onsubmit="return user_input()" class"login">	    
        <div class="login-wrap">
            ...
            <a class="btn btn-info btn-lg btn-block" href="__APP__/Error404/404" type="submit">Signup</a>
        </div>
      </form>
