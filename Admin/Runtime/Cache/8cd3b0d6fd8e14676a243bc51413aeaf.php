                             ...
                             <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="get" action="">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["email"]); ?> </label>
                                      </div>                                    
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">address <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["address"]); ?></label>
                                      </div>
									  <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">blog_title <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["blog_title"]); ?></label>
                                      </div>
									  <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">link <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["link"]); ?></label>
                                      </div>
									  <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Content <span class="required">*</span></label>
                                          <label for="cname" class="col-lg-10"><?php echo ($vo["content"]); ?></label>
                                      </div>
                                      <div class="form-group">
