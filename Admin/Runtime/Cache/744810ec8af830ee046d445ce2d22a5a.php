		...
		<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_piechart"></i>Projects</li>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                  <section class="panel">
                      ...
                      <div class="row">
                          <!-- Line -->
						  <?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="col-lg-6">
                              <section class="panel">
                                  <header class="panel-heading">
                                      <?php echo ($vo["name"]); ?><span style="float:right"><a href="__URL__/del/id/<?php echo ($vo["id"]); ?>">delete</a> |
									  <a href="__URL__/modify/id/<?php echo ($vo["id"]); ?>">update</a></span>
                                  </header>
                                  <div class="panel-body text-center">
									  <img height="300" width="450" src="__PUBLIC__/Uploads/<?php echo ($vo["filename"]); ?>"
                                  </div>
                              </section>
